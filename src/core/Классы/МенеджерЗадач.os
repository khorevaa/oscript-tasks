...
Процедура СохранитьЗадачу(Знач ИмяЗадачи, Знач НаименованиеЗадачи, Знач ЭтоГруппаЗадач,
	...
	ИначеЕсли ЭтоВстроеннаяЗадача(ИмяЗадачи) Тогда
		ДобавитьЗадачу(НаименованиеЗадачи, НаименованиеЗадачи, ИмяЗадачи, ТипЗадачи, АргументыЗадачи, ОпцииЗадачи, ПеременныеОкружения, ПерехватыватьПотоки);
	Иначе
		ДобавитьЗадачуOscript(ИмяЗадачи, НаименованиеЗадачи, ТипЗадачи, АргументыЗадачи, ОпцииЗадачи, ПеременныеОкружения, ПерехватыватьПотоки);
	КонецЕсли;
...
Процедура ДобавитьЗадачуOscript(Знач ИмяЗадачи, Знач НаименованиеЗадачи,
	...
	ДобавитьЗадачу(ИмяЗадачи, НаименованиеЗадачи, ИсполняемыйФайл, ТипЗадачи, АргументыЗадачи, ОпцииЗадачи, ПеременныеОкружения, ПерехватыватьПотоки);
...
Функция ДобавитьЗадачуВИндекс(Знач Индекс, Знач ИмяЗадачи, Знач НаименованиеЗадачи,
	...
	Задача = Новый Задача(ИмяЗадачи, НаименованиеЗадачи, Команда, ТипЗадачи, АргументыЗадачи, ОпцииЗадачи, ПеременныеОкруженияЗадачи, ПерехватыватьПотоки);
