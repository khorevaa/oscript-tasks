...
Процедура ВыполнитьПриложение()
	...
	Приложение = Новый КонсольноеПриложение("tasks-config",
											"Конфигуратор приложения ""tasks"" на OScript");
	...
	Приложение.Опция("l label", "", "представление задачи при сохранении");
	Приложение.Опция("name", "", "наименование задачи при сохранении");
