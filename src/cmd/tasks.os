...
Процедура ВыполнитьПриложение()
	...
	Приложение.Опция("t type", "process", "тип запуска задачи")
					...
					.Перечисление("cmd", "cmd", "задача будет запускаться как c помощью отдельного cmd/shell")
					;
...
Процедура ВыполнитьКоманду(Знач КомандаПриложения) Экспорт
	...
	Если ЭтоСохранениеЗадачи Тогда
		МенеджерЗадач.СохранитьЗадачу(ИмяЗадачи, НаименованиеЗадачи, ЭтоГруппаЗадач, ТипЗадачи, АргументыЗадачи, ОпцииЗадачи, ПеременныеОкружения);
	Иначе
		МенеджерЗадач.ВыполнитьЗадачу(ИмяЗадачи, ТипЗадачи, АргументыЗадачи, ОпцииЗадачи, ПеременныеОкружения);
	КонецЕсли;
